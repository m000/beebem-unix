...
#define WriteWord(ea, val)                                                                                             \
    {                                                                                                                  \
        program_write_byte_8((ea)&AMASK, (val)&0xff);                                                                  \
        program_write_byte_8(((ea) + 1) & AMASK, ((val) >> 8) & 0xff);                                                 \
    }
...
#define FETCHWORD(var)                                                                                                 \
    {                                                                                                                  \
        var = cpu_readop_arg(I.pc);                                                                                    \
...
#define POP(var)                                                                                                       \
    {                                                                                                                  \
        var = ReadWord(((I.base[SS] + I.regs.w[SP]) & AMASK));                                                         \
        I.regs.w[SP] += 2;                                                                                             \
    }
...
#define CompressFlags()                                                                                                \
    (WORD)(CF | (PF << 2) | (AF << 4) | (ZF << 6) | (SF << 7) | (I.TF << 8) | (I.IF << 9) | (DF << 10) | (OF << 11))
