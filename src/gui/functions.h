...
#define EG_ASSERT_MALLOC(n)                                                                                            \
    {                                                                                                                  \
        ...
        if (!b)                                                                                                        \
        {                                                                                                              \
            EG_Log(EG_LOG_DEBUG5, dL " Assertion FAILED for " EG_PTRFMT "", dR, EG_CAST_PTR_TO_INT(n));                \
                                                                                                                       \
...
#define EG_ASSERT_MALLOC(n)                                                                                            \
    {                                                                                                                  \
        ...
        if (!b)                                                                                                        \
        {                                                                                                              \
            EG_Log(EG_LOG_DEBUG5, dL "Assertion FAILED for " EG_PTRFMT "", dR, (b ? "PASSED" : "FAILED"),              \
...
#define EG_VASSERT_MALLOC(n, s)                                                                                        \
    {                                                                                                                  \
        ...
        if (!b)                                                                                                        \
        {                                                                                                              \
            EG_Log(EG_LOG_DEBUG5, dL " Assertion FAILED for " EG_PTRFMT ": %s", dR, EG_CAST_PTR_TO_INT(n), message);   \
                                                                                                                       \
            exit(EG_EXITCODE_MALLOCASSERTION);                                                                         \
        }                                                                                                              \
    }
...
#define EG_VASSERT_MALLOC(n, s)                                                                                        \
    {                                                                                                                  \
        ...
        if (!b)                                                                                                        \
        {                                                                                                              \
            EG_Log(EG_LOG_DEBUG5, dL "Assertion FAILED for " EG_PTRFMT ": %s", dR, (b ? "PASSED" : "FAILED"),          \
