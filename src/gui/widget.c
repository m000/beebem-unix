...
static void Callback_Destroy(EG_Widget *widget_ptr)
{
     ...
     */
    EG_Log(EG_LOG_WARNING, dL "EG_Widget Callback_Destroy function called", dR);
...
static EG_BOOL InitializeWidgetStruct(EG_Widget *widget_ptr, const char *name_ptr, EG_StringHash type)
{
    ...
    if (++unique_ID == 0)
    {
        EG_Log(EG_LOG_INFO, dL "EG_Widget struct ID counter wrapped.", dR);
        unique_ID++;
    }
     ...
     */
    if (EG_Widget_SetName(widget_ptr, name_ptr) == EG_FALSE)
        return (EG_FALSE);
...
EG_Widget *EG_Widget_Alloc(const char *name_ptr, EG_StringHash type)
{
    ...
    {
        EG_Log(EG_LOG_WARNING, dL "Unable to malloc EG_Widget struct", dR);
        return (NULL);
    }
...
void EG_Widget_CallDestroy(EG_Widget *widget_ptr)
{
    ...
    {
        EG_Log(EG_LOG_ERROR,
               dL "EG_Widget.func_destroy_ptr"
                  " = NULL, widget not freed!",
               dR);
    }
    else
    {
        func_ptr = (EG_Callback_Destroy)widget_ptr->func_destroy_ptr;
...
EG_BOOL EG_Widget_CallPaint(EG_Widget *widget_ptr, SDL_Rect rect)
{
    ...
    {
        func_ptr = (EG_Callback_Paint)widget_ptr->func_paint_ptr;
...
EG_BOOL EG_Widget_CallSDLEvent(EG_Widget *widget_ptr, SDL_Event *event_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_SDL_Event)widget_ptr->func_sdl_event_ptr;
...
EG_BOOL EG_Widget_CallVisible(EG_Widget *widget_ptr, EG_BOOL visible)
{
    ...
    {
        func_ptr = (EG_Callback_Visible)widget_ptr->func_visible_ptr;
...
EG_BOOL EG_Widget_CallEnabled(EG_Widget *widget_ptr, EG_BOOL enabled)
{
    ...
    {
        func_ptr = (EG_Callback_Enabled)widget_ptr->func_enabled_ptr;
...
EG_BOOL EG_Widget_CallGotFocus(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_GotFocus)widget_ptr->func_got_focus_ptr;
...
void EG_Widget_CallLostFocus(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_LostFocus)widget_ptr->func_lost_focus_ptr;
...
EG_BOOL EG_Widget_CallStopped(EG_Widget *widget_ptr, EG_BOOL stopped)
{
    ...
    {
        func_ptr = (EG_Callback_Stopped)widget_ptr->func_stopped_ptr;
...
void EG_Widget_CallAttach(EG_Widget *widget_ptr, EG_StringHash attach_to_type, void *attach_to_ptr, EG_BOOL attached)
{
    ...
    {
        func_ptr = (EG_Callback_Attach)widget_ptr->func_attach_ptr;
...
void EG_Widget_CallUserOnChange(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_User_OnChange)widget_ptr->func_user_change_ptr;
...
void EG_Widget_CallUserOnClick(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_User_OnClick)widget_ptr->func_user_click_ptr;
...
void EG_Widget_CallUserOnEvent(EG_Widget *widget_ptr, SDL_Event *event_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_User_OnEvent)widget_ptr->func_user_event_ptr;
...
void EG_Widget_CallUserOnLostFocus(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_User_OnLostFocus)widget_ptr->func_user_lostfocus_ptr;
...
void EG_Widget_CallUserOnGotFocus(EG_Widget *widget_ptr)
{
    ...
    {
        func_ptr = (EG_Callback_User_OnGotFocus)widget_ptr->func_user_gotfocus_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnChange(EG_Widget *widget_ptr, EG_Callback_User_OnChange user_callback_ptr,
...
EG_BOOL EG_Widget_SetUserCallback_OnClick(EG_Widget *widget_ptr, EG_Callback_User_OnClick user_callback_ptr,
...
EG_BOOL EG_Widget_SetUserCallback_OnEvent(EG_Widget *widget_ptr, EG_Callback_User_OnEvent user_callback_ptr,
...
EG_BOOL EG_Widget_SetUserCallback_OnLostFocus(EG_Widget *widget_ptr, EG_Callback_User_OnLostFocus user_callback_ptr,
                                              void *user_event_value_ptr)
{
    CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);
...
EG_BOOL EG_Widget_SetUserCallback_OnGotFocus(EG_Widget *widget_ptr, EG_Callback_User_OnGotFocus user_callback_ptr,
                                             void *user_event_value_ptr)
{
    CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);
...
EG_BOOL EG_Widget_SetValue_String(EG_Widget *widget_ptr, const char *string_ptr)
{
     ...
     */
    if (string_ptr == NULL || strlen(string_ptr) > EG_WIDGET_MAX_STRING_VALUE_SIZE)
    {
...
EG_BOOL EG_Widget_RepaintLot(EG_Widget *widget_ptr)
{
    ...
    return (EG_Widget_CallPaint(widget_ptr, EG_Widget_GetDimension(widget_ptr)));
}
