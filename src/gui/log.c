...
char *error_descriptions[9] = {"[FATAL] ", "[INFO]  ", "[ERROR] ", "[WARN]  ",
                               "[DEBUG] ", "      X ", "   ---> ", "   <--- "};
#endif
...
void pDEBUG(const char *psFormat, ...)
{
    CALL_VLOG_PRINTF(eLOG_DEBUG);
}
void pDISABLED(const char *psFormat, ...)
{
    CALL_VLOG_PRINTF(eLOG_DISABLED);
}
void pTRACKER_E(const char *psFormat, ...)
{
    CALL_VLOG_PRINTF(eLOG_TRACKER_E);
}
void pTRACKER_L(const char *psFormat, ...)
{
    CALL_VLOG_PRINTF(eLOG_TRACKER_L);
}
#endif
