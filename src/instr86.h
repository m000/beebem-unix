...
static void (*PREFIX186(_instruction)[256])(void) = {
    ...
    PREFIX186(_invalid),     PREFIX186(_adc_br8), /* 0x10 */
    ...
    PREFIX186(_invalid),     PREFIX186(_invalid), PREFIX186(_invalid),
    PREFIX186(_invalid),     PREFIX186(_invalid), PREFIX186(_push_d16), /* 0x68 */
    ...
    PREFIX186(_aam),                                                    /* 0xd4 */
    PREFIX186(_aad),                                                    /* 0xd5 */
    PREFIX186(_invalid),     PREFIX186(_xlat),                          /* 0xd7 */
