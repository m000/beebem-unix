...
static void PREFIX86(_interrupt)(unsigned int_num)
{
    ...
    //        I.regs.w[AX], I.regs.w[BX], I.regs.w[CX], I.regs.w[DX], I.regs.w[SI], I.regs.w[DI], I.sregs[DS],
    //        I.sregs[ES],
...
static void PREFIX86(_mov_wsreg)(void) /* Opcode 0x8c */
{
    ...
    if (ModRM & 0x20)
        return; /* HJB 12/13/98 1xx is invalid */
...
static void PREFIX186(_enter)(void) /* Opcode 0xc8 */
{
    ...
    level = FETCH;
    ICOUNT -=
        (level == 0) ? cycles.enter0 : (level == 1) ? cycles.enter1 : cycles.enter_base + level * cycles.enter_count;
    PUSH(I.regs.w[BP]);
...

{
    ...
    sprintf(buff, "[%04x:%04x] AX=%04x BX=%04x CX=%04x DX=%04x SI=%04x DI=%04x DS=%04x ES=%04x SS:SP = %04x:%04x ",
            I.sregs[CS], (I.pc - I.base[CS]) & 0xffff, I.regs.w[AX], I.regs.w[BX], I.regs.w[CX], I.regs.w[DX],
            I.regs.w[SI], I.regs.w[DI], I.sregs[DS], I.sregs[ES], I.sregs[SS], I.regs.w[SP]);
