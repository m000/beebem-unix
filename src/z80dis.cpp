...
int Z80_Disassemble(int adr, char *s)
{
    ...
    case 0x00:
        ...
        case 0x00:
            ...
            case 0x02:
                strcpy(s, "DJNZ\t");
                sprintf(stemp, "%4.4Xh", adr + 2 + (signed char)ReadZ80Mem(adr + 1));
                strcat(s, stemp);
                size = 2;
                break;
            case 0x03:
        ...
        case 0x01:
            ...
            else
            {
                ...
                strcat(s, dreg[d >> 1]);
                strcat(s, ",");
                sprintf(stemp, "%4.4Xh", ReadZ80Mem(adr + 1) + (ReadZ80Mem(adr + 2) << 8));
                strcat(s, stemp);
                size = 3;
            }
            break;
        ...
        case 0x06: // LD	d,n
            ...
            strcat(s, reg[d]);
            strcat(s, ",");
            sprintf(stemp, "%2.2Xh", ReadZ80Mem(adr + 1));
            strcat(s, stemp);
            size = 2;
            break;
        case 0x07: {
            ...
            if (d & 1)
            {
                ...
                default: // 0x01 (0xDD) = IX, 0x03 (0xFD) = IY
                    ...
                    case 0x36:
                        ...
                        strcat(s, stemp);
                        strcat(s, "),");
                        sprintf(stemp, "%2.2Xh", ReadZ80Mem(adr + 2));
                        strcat(s, stemp);
                        size += 2;
                        break;
                    case 0x39:
