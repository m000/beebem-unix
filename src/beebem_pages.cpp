...
static void ReCenterWindow(EG_Window *window_ptr)
{
    if (window_ptr->surface_ptr != NULL)
    {
        ...
        {
            window_ptr->dimension.y = window_ptr->surface_ptr->h - (int)(window_ptr->dimension.h * EG_Draw_GetScale());
        }
        else if (EG_Draw_GetScale() == 1.0)
        {
            window_ptr->dimension.y = (window_ptr->surface_ptr->h - window_ptr->dimension.h) / 2;
        }
        else
        {
...
// [TODO] MenuItemCheck function etc (based on ID only, searches for widget in above array and then changes it's state
...
int UpdateGUIOption(int windows_menu_id, int is_selected)
{
    ...
    for (i = 0; i < win_menu_count; i++)
    {
        if (win_menu[i].windows_menu_id == windows_menu_id)
        {
            ...
            // printf("Found: %s is of type %X %X %X\n", EG_Widget_GetName(ptr), (EG_StringHash) EG_Widget_GetType(ptr)
            // , (EG_StringHash) EG_Widget_Type_TickBox, EG_Widget_Type_RadioButton);
...
int Save_GTK_File_Selector(char *filename_ptr)
{
    ...
    g_signal_connect(G_OBJECT(GTK_FILE_SELECTION(filew)->ok_button), "clicked", G_CALLBACK(file_ok_sel),
                     (gpointer)filew);
...
static void Main_Button_About(EG_Widget *widget_ptr, void *user_ptr)
{
    ...
    // printf("MESSAGE BOX\n");
    EG_MessageBox(screen_ptr, EG_MESSAGEBOX_INFORMATION, "BeebEm for UNIX!", ABOUT_MESSAGE, "OK", NULL, NULL, NULL, 0);
...
#define MENU_CALC_LOC(c, r, b)                                                                                         \
    loc = CalcRect(10 + c * (win.w / 2 - 30) + 10 + (14 * c), 30 + (r + 1) * 20 + b * 10, win.w / 2 - 20 - 5, 19)
...
#define SYSTEM_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 17 + b * 10, win.w - 40, 16)
    ...
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption, CreateWindowsMenuItem(ID_DOCONLY, widget_ptr));

    SYSTEM_CALC_LOC(15, 0);
    widget_ptr = EG_RadioButton_Create("system:6502:extras", col, "Common extras", loc);
    EG_RadioGroup_AddButton(group2_ptr, widget_ptr);
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption, CreateWindowsMenuItem(ID_EXTRAS, widget_ptr));

    SYSTEM_CALC_LOC(16, 0);
    widget_ptr = EG_RadioButton_Create("system:6502:fullset", col, "Full set", loc);
    EG_RadioGroup_AddButton(group2_ptr, widget_ptr);
    EG_RadioGroup_Select(widget_ptr);
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption, CreateWindowsMenuItem(ID_FULLSET, widget_ptr));
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, System_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define SCREEN_CALC_LOC(c, r, b)                                                                                       \
    loc = CalcRect(20 + c * (win.w / 2 - 20), 26 + (r + 1) * 17 + b * 10, win.w / 2 - 20 - 5, 16)
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_640X512);
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_640X480_S);
    EG_RadioGroup_AddButton(group4_ptr, widget_ptr);
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_640X480_V);
    EG_RadioGroup_AddButton(group4_ptr, widget_ptr);
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_320X240_S);
    EG_RadioGroup_AddButton(group4_ptr, widget_ptr);
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_320X240_V);
    EG_RadioGroup_AddButton(group4_ptr, widget_ptr);
    ...
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Fullscreen_Resolution, (void *)RESOLUTION_320X256);
    EG_RadioGroup_AddButton(group4_ptr, widget_ptr);
    ...
    widget_ptr = EG_ToggleButton_Create("res:640x512", col, "640x512", loc);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_640X512);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    gui.widget_windowed_640x512 = widget_ptr;

    SCREEN_CALC_LOC(1, 12, 6);
    widget_ptr = EG_ToggleButton_Create("res:640X480_S", col, "640x480 (scaled)", loc);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_640X480_S);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    gui.widget_windowed_640x480_S = widget_ptr;

    SCREEN_CALC_LOC(0, 13, 6);
    widget_ptr = EG_ToggleButton_Create("res:640x480_V", col, "640x480 (centered)", loc);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_640X480_V);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    gui.widget_windowed_640x480_V = widget_ptr;

    SCREEN_CALC_LOC(1, 13, 6);
    widget_ptr = EG_ToggleButton_Create("res:320X240_S", col, "320x240 (scaled)", loc);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_320X240_S);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    gui.widget_windowed_320x240_S = widget_ptr;

    SCREEN_CALC_LOC(0, 14, 6);
    widget_ptr = EG_ToggleButton_Create("res:320x240_V", col, "320x240 (centered)", loc);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_320X240_V);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    ...
    widget_ptr = EG_ToggleButton_Create("res:320X256", col, "320x256", loc);
    EG_RadioGroup_AddButton(group5_ptr, widget_ptr);
    (void)EG_ToggleButton_SetMyCallback_OnClick(widget_ptr, Change_Windowed_Resolution, (void *)RESOLUTION_320X256);
    ...
    */
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, Screen_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define SOUND_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 17 + b * 10, win.w - 40, 16)
    ...
    EG_Window_AddWidget(window_ptr, widget_ptr);
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption, CreateWindowsMenuItem(IDM_SPEECH, widget_ptr));
...
#define SPEED_COUNT 14
    ...
    int speed_menu_id[] = {IDM_FIXEDSPEED100,  IDM_FIXEDSPEED50,  IDM_FIXEDSPEED10,   IDM_FIXEDSPEED5,
                           IDM_FIXEDSPEED2,    IDM_FIXEDSPEED1_5, IDM_FIXEDSPEED1_25, IDM_FIXEDSPEED1_1,
                           IDM_REALTIME,       IDM_FIXEDSPEED0_9, IDM_FIXEDSPEED0_75, IDM_FIXEDSPEED0_5,
                           IDM_FIXEDSPEED0_25, IDM_FIXEDSPEED0_1};
...
#	define ABOUT_CALC_LOC(r, b) loc = CalcRect(20, 10+r*16+b*10, win.w-40, 16)
    ...
    ABOUT_CALC_LOC(0, 0);
    widget_ptr = EG_Label_Create("lab_about", col, EG_LABEL_ALIGN_CENTER, "Beebem - BBC Model B / Master 128 Emulator",
loc); (void) EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define DEVICES_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 17 + b * 8, win.w - 40, 16)
    ...
    if (peripherals_count > 0)
    {
        ...
        DEVICES_CALC_LOC(6, 0);
        loc.x -= 10;
        loc.y += 8;
        loc.h = peripherals_count - (17 * 2);
        loc.w += 20;
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, Devices_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define TAPES_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 20 + b * 10, win.w - 40, 19)
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, Tapes_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define DISKS_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 20 + b * 10, win.w - 40, 19)
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, Disks_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
static void Disks_SaveRegistry(EG_Widget *widget_ptr, void *user_ptr)
{
    ...
    if (SaveFakeRegistry() == FALSE)
    {
        ...
        EG_MessageBox(screen_ptr, EG_MESSAGEBOX_STOP, "Failed save", "Could not save registry! Save failed!", "OK",
                      NULL, NULL, NULL, 0);
    }
}
...
#define KEYBOARD_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 20 + b * 10, win.w - 40, 16)
    ...
    DISKS_CALC_LOC(3, 0);
    widget_ptr =
        EG_Button_Create("disks:Drive:run_disc", col, EG_BUTTON_ALIGN_CENTER, "Select, load and run a disc", loc);
    ...
    DISKS_CALC_LOC(8, 0);
    widget_ptr =
        EG_Button_Create("disks:Drive0:new_disk", col, EG_BUTTON_ALIGN_CENTER, "Create new disc image in drive 0", loc);
    EG_Window_AddWidget(window_ptr, widget_ptr);
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption,
    ...
    DISKS_CALC_LOC(9, 0);
    widget_ptr =
        EG_Button_Create("disks:Drive1:new_disk", col, EG_BUTTON_ALIGN_CENTER, "Create new disc image in drive 1", loc);
    EG_Window_AddWidget(window_ptr, widget_ptr);
    (void)EG_TickBox_SetMyCallback_OnClick(widget_ptr, ProcessGUIOption,
    ...
    widget_ptr =
        EG_Label_Create("disks:lab_1", col, EG_LABEL_ALIGN_LEFT, "Watch out for GTK opening the file selector", loc);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);

    DISKS_CALC_LOC((18 + 1), 0);
    loc.y--;
    widget_ptr =
        EG_Label_Create("disks:lab_2", col, EG_LABEL_ALIGN_LEFT, "behind the emulator window!                ", loc);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
    col = MENU_COLORS; // CalcColor(191+32, 191+32, 0);
    ...
    /*
        ...
        DISKS_CALC_LOC(16, 0);
        widget_ptr = EG_Button_Create("disks:acorn", col, EG_BUTTON_ALIGN_CENTER, "Acorn 1770 DFS Board Drive
       Controller", loc); (void) EG_Window_AddWidget(window_ptr, widget_ptr); (void)
       EG_TickBox_SetMyCallback_OnClick(widget_ptr, Disks_AcornDFS, NULL);

        DISKS_CALC_LOC(17, 0);
        widget_ptr = EG_Button_Create("disks:watford", col, EG_BUTTON_ALIGN_CENTER, "Watford DDFS Ext. board for Model
       B", loc); (void) EG_Window_AddWidget(window_ptr, widget_ptr); (void) EG_TickBox_SetMyCallback_OnClick(widget_ptr,
       Disks_WatfordDFS, NULL);

        DISKS_CALC_LOC(18, 0);
        widget_ptr = EG_Button_Create("disks:opus", col, EG_BUTTON_ALIGN_CENTER, "Opus DDFS Board Drive Controller",
       loc); (void) EG_Window_AddWidget(window_ptr, widget_ptr); (void) EG_TickBox_SetMyCallback_OnClick(widget_ptr,
       Disks_OpusDFS, NULL);
    ...
    */
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, Keyboard_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
...
#define AMX_CALC_LOC(r, b) loc = CalcRect(20, 10 + r * 20 + b * 10, win.w - 40, 16)
    ...
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, AMX_Button_Back, &gui);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
