...
class BeebWin
{
  ...
  public:
    ...
    //+>
    bool CursorShouldBeHidden(void)
    {
        if (m_HideCursor)
            return true;
        else
    ...
    */
    ...
    void SetFullScreenToggle(bool fullscreen)
    {
  ...
  private:
    ...
    bool TextToSpeechSearch(TextToSpeechSearchDirection dir, TextToSpeechSearchType type);
